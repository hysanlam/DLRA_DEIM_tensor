...
%F_1=accessMode1Columns(@(i,j,k) F(X,i,j,k),p2,p3, sub_sample_1, n);
...
%F_2=accessMode2Columns(@(i,j,k) F(X,i,j,k),p1,p3, sub_sample_2, n);
...
%F_3=accessMode3Columns(@(i,j,k) F(X,i,j,k),p1,p2, sub_sample_3, n);
